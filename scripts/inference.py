...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", type=str, default="../../dataset/anime-seg/test2", help="input data dir"
    )
    parser.add_argument("--out", type=str, default="out", help="output dir")
    parser.add_argument(
        "--img-size", type=int, default=1024, help="hyperparameter, input image size of the net"
    )
    ...
    parser.add_argument(
        "--only-matted", action="store_true", default=False, help="only output matted image"
    )
    parser.add_argument(
        "--bg-white",
        action="store_true",
